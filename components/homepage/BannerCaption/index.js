...
const BannerCaption = ({ featuredPost, type }) => {
  ...
  //const redirectLink  =  !isEmptyObj(featuredPost) && (router && router.locale === 'en' ? (`/${type}/${featuredPost.articleSlug}`) : (`${router.locale}/${type}/${featuredPost.articleSlug}`) )
  //const redirectLink = !isEmptyObj(featuredPost) && `/${type}/${featuredPost.articleSlug}`
  const onClickHandler = () => {
    router.push( `/${type}/${featuredPost.articleSlug}` )
  }

  return (
    <>
      {!isEmptyObj(featuredPost) && (
        <BannerCaptionWrapper onClick={onClickHandler}>
