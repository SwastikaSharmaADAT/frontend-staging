...
function SingleItem({
  ...
  const nameOfUser = getUserName(follower._id)
    ...
    return (
        <FollowingList className={follower.confirmedStatus ? '' : 'grey'} key={follower._id._id}>
          <FollowsWrap>
            <FollowingThumb>
              <img
                src={
            ...
            <FollowsNameWrap>
              <FollowsName onClick={() => redirectToUserProfile(follower._id.username)}>
                { nameOfUser }
              </FollowsName>
              <FollowersCount>
                { follower.confirmedStatus ? 'Verified' : 'Unverified' }
              </FollowersCount>
            </FollowsNameWrap>
          </FollowsWrap>
        </FollowingList>
