...
const LegacyUserWelcomePopup = (props) => {
        ...
        <PageWrapper>
          <Wrapper>
            <LoginCon>
              ...
              <form>
                <CommonForm>
                  <Button type="submit" className="btn btn-primary" onClick={closeLegacyWelcomePopup}>
                    {t(`translation:legacyWelcomePopup.closeBtn`)}
                  </Button>
                </CommonForm>
              </form>
            </LoginCon>
...
LegacyUserWelcomePopup.propTypes = {
  closeModal: PropTypes.func,
  open: PropTypes.bool,
}

export default LegacyUserWelcomePopup
