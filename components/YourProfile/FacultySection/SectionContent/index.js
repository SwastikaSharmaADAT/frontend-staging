...
const SectionContent = (props) => {
  ...
  return (
    <>
      <SectionContentWrap>
        {props.userData && props.userData.description && !isEditingFaculty ? (
        ...
        {isEditingFaculty ? (
          <DescriptionBox>
            <SectionDespTextarea
              ...
              maxLength={1000}
              placeholder={t(`faculty.placeholderDescription`)}
            ></SectionDespTextarea>
            <span className="countDiv">
              {props.descCharCount}
              {t(`faculty.characterLimit`)}
            </span>
          </DescriptionBox>
        ) : null}
        <ImagesSection
          ...
          facultyImages={props.facultyImages}
