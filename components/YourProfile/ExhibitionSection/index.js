...
const ExibitionsSection = () => {
  ...
  let articles = []
  if (exhibitionArticles && exhibitionArticles.length > 2) {
    articles = exhibitionArticles.slice(0, 2)
  } else {
  ...
  return (
    <>
      {articles && articles.length > 0 && (
        <NeedHelpSectionWrap>
          <SectionHead>
            <SectionHeading>{t(`exhibitions`)}</SectionHeading>
            <SectionHeadButtons onClick={() => openInNewTab(`/exhibition`)}>
...
export default ExibitionsSection
