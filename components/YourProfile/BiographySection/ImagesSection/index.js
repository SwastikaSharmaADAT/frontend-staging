...
const ImagesSection = (props) => {
  ...
  return (
    <>
      {!isEditingBiography && props.images && props.images.length > 0 ? (
        <ImagesSectionWrap>
      ...
      ) : props.images && props.images.length === 0 && !props.description && !isEditingBiography ? (
        <div className="NoWrap">{t(`biography.noBiographyText`)}</div>
      ) : props.images && props.images.length === 0 && props.description && !isEditingBiography ? (
