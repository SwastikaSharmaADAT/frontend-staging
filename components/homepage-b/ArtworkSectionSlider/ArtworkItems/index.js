...
const ItemsWrapper = styled.div`
  ...
  padding: 0 0 10px 0;
  color: #ffffff;
  background: linear-gradient(211.8deg, #222222 0%, #111 100%);
  border: 1px solid rgba(255, 255, 255, 0.02);
  box-sizing: border-box;
  box-shadow: 1px 1px 20px 5px rgba(0, 0, 0, 0.1);  text-align: center;
  min-height: 100%;
  ...
  return (
    <>
      <ItemsWrapper>
        ...
        <Username onClick={() => openInNewTab( `/user/${user.username}`)}>
          {user && nameOfUser}
        </Username>
