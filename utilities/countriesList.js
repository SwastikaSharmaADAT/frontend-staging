const countries = [
    ...
    { label: 'Korea North (DPRK)', value: 'Korea' },
    // { label: 'South Korea (ROK)', value: 'South Korea' },
    { label: 'Korea South (ROK) ', value: 'Korea South' },
  ...
  export const countriesData = (t) => countries.map((o) => ({ ...o, label: t(`countries:${o.label}`) }))
